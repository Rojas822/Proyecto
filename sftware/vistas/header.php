...
<html>
  <head>
   ...
   <title>IE Jorge Clemente Palacios</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <span class="logo-mini"><b>IE</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>IE</b> Jorge Clemente Palacios </span>
    </a>
...
if ($_SESSION['escritorio']==1) {
  echo ' <li><a href="escritorio.php"><i class="fa  fa-dashboard (alias)"></i> <span>Cursos-Estudiantes</span></a>
        </li>';
}
        ?> 
...
if ($_SESSION['grupos']==1) {
  echo '<li class="treeview">
          <a href="#">
            <i class="fa fa-shopping-cart"></i> <span>Administrar Cursos</span>
